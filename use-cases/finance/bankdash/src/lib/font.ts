...
export const interLocal = localFont({
    src: [
        // --- Extra Light (200) ---
        {
            path: '../../public/assets/fonts/Inter_18pt-ExtraLight.ttf',
            weight: '200',
            style: 'normal',
        },
        {
            path: '../../public/assets/fonts/Inter_18pt-ExtraLightItalic.ttf',
            weight: '200',
            style: 'italic',
        },
        // --- Light (300) ---
        ...
        {
            path: '../../public/assets/fonts/Inter_18pt-BoldItalic.ttf',
            weight: '700',
            style: 'italic',
        },
        // --- Extra Bold (800) ---
        ...
        {
            path: '../../public/assets/fonts/Inter_18pt-ExtraBoldItalic.ttf',
            weight: '800',
            style: 'italic',
        },
        // --- Black (900) ---
        ...
        {
            path: '../../public/assets/fonts/Inter_18pt-BlackItalic.ttf',
            weight: '900',
            style: 'italic',
        },
    ],
